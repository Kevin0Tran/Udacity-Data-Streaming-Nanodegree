...
class Line:
    ...
    def process_message(self, message):
        ...
        if message.topic()=="Chicago.CTA.station.table.v1": # Set the conditional correctly to the stations Faust Table
            try:
        ...
        elif message.topic()=="Chicago.CTA.turnstile": # Set the conditional to the KSQL Turnstile Summary Topic
